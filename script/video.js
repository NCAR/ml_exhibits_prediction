(function( window, document ) {
		...
		fullScreenToggleLink = document.getElementById("fullScreen")
	...
	var videoPlayer = {
		...
		fullScreenOn : function() {
			...
			//switch FS image
			document.getElementById("fullScreenImage").src="../images/windows_nofullscreen_128x128.png";
			...
			fullScreenToggleLink.className = "fs-active control";
		...
		fullScreenOff : function() {
			...
			video.className = '';
			video.style.cssText = '';
			fullScreenToggleLink.className = "control";
			videoControls.className = '';
			//switch FS image
			document.getElementById("fullScreenImage").src="../images/windows_fullscreen_128x128.png";
		},
		
		handleLinkPresses : function() {
